...
export const DAILY_DEVOTIONS: Devotion[] = [
  ...
  { text: "We know that all things work together for good for those who love God, for those who are called according to his purpose.", ref: "Romans 8:28", reflection: "Not all things are good — but in His hands, all things are working towards it." },
  ...
  { text: "But when Jesus saw it, he was moved with indignation, and said to them, “Allow the little children to come to me! Don’t forbid them, for God’s Kingdom belongs to such as these.”", ref: "Mark 10:14", reflection: "The tenderness of Christ towards children is His heart towards yours." },
